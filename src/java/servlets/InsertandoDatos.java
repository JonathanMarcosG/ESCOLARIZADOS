            ...
            switch (Resultado) {
                ...
                case 0:
                    ...
                    beanMail.setCuerpo("<b><font size=4 face=\"arialblack\"> Durante el proceso de registro recibirá los  siguientes  correos, por favor permanezca al pendiente: \n"
                            ...
                            + "<br>"
                            + " <a href=\"" + Constantes.APP_HOME + "\" target=\"_blank\">" + Constantes.APP_HOME
                            + " </a> en el apartado de contacto.</font></b>"
                            + "<br><br>"
                            ...
                            + "\nEn caso de que su referencia  expire usted podrá renovarla ingresando  a la liga de <a href=\"" + Constantes.APP_HOME + "\" target=\"_blank\">"
                            + Constantes.APP_HOME + " </a> en el apartado de \"Renovar referencia\" considerando que "
                            + "<br><br>"
                            + "<u1>"
                ...
                case 12356:
                    ...
                    BMail beanMail2 = new BMail();
                    beanMail2.setCuerpo("<b><font size=4 face=\"arialblack\"> Durante el proceso de registro recibirá los  siguientes  correos, por favor permanezca al pendiente: \n"
                            + "<br><br>"
                            + " 1.-Correo  de generación de preficha, que se le enviará  al concluir el registro de sus datos. \n"
                            + "<br>"
                            + "2.-Correo de liberación de pago, en un periodo máximo de 3 a 4 días hábiles después de haber realizado el pago bancario. \n"
                            ...
                            + "Recibirá una  notificación cuando su  pago haya sido  procesado, permanezca al pendiente de  su correo. "
                            + "Por favor haga click en el siguiente enlace para que pueda ver su preficha. "
                            + "<a href=" + url2 + ">Genera Preficha</a></font>.");
                    //Mail m = new Mail();
                    //boolean ret = m.sendMail(beanMail, "aspirantes@ittoluca.edu.mx", aspirante.getCorreo(), "11280672", true, "Aspirante  Tecnológico de Toluca: Generar Preficha");
